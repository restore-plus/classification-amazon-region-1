...
Classification using Landsat-8 (2014 - 2020) for Region 1 defined in the scope of the Restore+ Project.
...
Next, open the `classification-amazon-region-1` directory in the RStudio and install the examples package:
